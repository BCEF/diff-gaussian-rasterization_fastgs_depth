...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, num_buckets, color, radii, geomBuffer, binningBuffer, imgBuffer, sampleBuffer, accum_metric_counts, invdepth = _C.rasterize_gaussians(*args)
        ...
        return color, radii, accum_metric_counts, invdepth

    @staticmethod
    def backward(ctx, grad_out_color, _, g_metric, grad_out_depth):
